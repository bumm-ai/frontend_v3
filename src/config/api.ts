...
export const ENDPOINTS = {
  ...
  CONTRACT_SELF_DEPLOY_ARTIFACT: (uid: string) => `/api/v1/contracts/${uid}/self-deploy/artifact`,
  CONTRACT_SELF_DEPLOY_CONFIRM:  (uid: string) => `/api/v1/contracts/${uid}/self-deploy/confirm`,
